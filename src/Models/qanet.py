...
class QANet(nn.Module):
    ...
    def __init__(self, word_mat, char_mat, args):
        ...
        self.emb = Embedding(
            d_word, d_char, dropout, dropout_char,
        ...
        base_enc = EncoderBlock(
            d_model, num_heads, dropout,
            conv_num=2, k=5, length=len_c,
            init_name=init_name, act_name=act_name,
            norm_name=norm_name, norm_groups=norm_groups
        )

        # Use independent encoder stacks for M1, M2, and M3
    ...
    def forward(self, Cwid, Ccid, Qwid, Qcid):
        ...
        # Embedding.forward expects (char_emb, word_emb)
